 ...
 * <p/>
 * The BaseBean class simplifies the validate() and reset() methods by allowing
 * them to be managed without Struts dependencies. Quite simply, subclasses can
 * override the parameterless validate() and reset() methods and set errors and
 * messages using the ActionContext class.
 * <p/>
 * <i>Note: Full error, message and internationalization support is not
 * complete.</i>
 * <p/>
