...
class Boot {
  ...
  def boot {
    ...
    def sitemap(): SiteMap = SiteMap(
      ...
      Menu.i("Membase Hosts List") / "membasehosts",
      Menu.i("Membase Env Testing") / "membaseenv",
      Menu.i("Rabbitmq Hosts List") / "rabbitmqhosts",
      Menu.i("Rabbitmq Env Testing") / "rabbitmqenv",
